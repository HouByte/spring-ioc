...
import cn.bugio.spring.mini.exception.HandleRequestException;
import cn.bugio.spring.mini.exception.ResourceNotFoundException;
import cn.bugio.spring.mini.rest.constant.RequestInfo;
import cn.bugio.spring.mini.rest.constant.ResponseEntity;
import cn.bugio.spring.mini.rest.convert.Converter;
import cn.bugio.spring.mini.rest.convert.ConverterFactory;
import cn.bugio.spring.mini.rest.mapping.ControllerBean;
import cn.bugio.spring.mini.rest.mapping.ControllerMapping;
import cn.bugio.spring.mini.rest.mapping.ControllerMappingParameter;
import cn.bugio.spring.mini.rest.mapping.ControllerMappingRegistry;
import cn.bugio.spring.mini.core.web.WebServer;
...
final class RequestHandler {
    ...
    private Object execute(ControllerMapping mapping, Class<?>[] paramTypes, Object[] paramValues) throws Exception {
        Object bean = BeanFactory.getBean(mapping.getClassName());
...
//        }
        Method method = bean.getClass().getMethod(mapping.getClassMethod(), paramTypes);
